...
* ...230822piu_g update `810.46-Product_Features.md` & `adma_catalog.md` ref section _ARINT own objects and components_ ref & link to `810-DSGN/810.03 System Data & Objects.md`
