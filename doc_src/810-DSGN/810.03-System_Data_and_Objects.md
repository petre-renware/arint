...
* Objects `code-name` is not case sensitive and is a good rule to use always uppercase. The system will always convert even from the save step, the data objects `code-name` to uppercase
