...
* `[1]` **ARINT CORE** administration and management user interface
* ...
* ...
...
ARCLST - this on same LAN - proposal to name it `ARCLSTnode`
    * -#FIXME_candrop (1,m) x ARINT framework (instead of ARSRV)
    * -#FIXME_candrop 1 x Databases
    * -#FIXME_candrop 1 x ARINT CORE
